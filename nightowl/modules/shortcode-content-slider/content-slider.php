...
function flow_content_slider_scripts() {
	wp_enqueue_script( 'flow-content-slider-script', get_template_directory_uri() . '/modules/shortcode-content-slider/content-slider.js', array( 'jquery' ), false, true );
	wp_enqueue_style( 'flow-content-slider-style', get_template_directory_uri() . '/modules/shortcode-content-slider/content-slider.css' );
}
